    ...
    <section class="">
        <div class="d-flex flex-column justify-content-center align-items-center gap col-lg-11">
            ...
            <div class="col-lg-6 col-xl-5 col-xxl-4 text-center">
                <h1 class="product mb-5 text-center">Registeration Form</h1>
            </div>
            <form method="post" action="Register">
            	<div class="col-11 col-md-12 col-lg-12 mx-auto mx-lg-0 border border-2 border-black rounded-4 p-sm-5 p-3" >
                	...
                	<div class="mt-3 d-flex align-items-center justify-content-center w-100">
                    	<label class=" col-5 col-lg-5 col-xxl-4 mate5">Name : </label>
                    	<input type="text" class="ms-3 col-6 col-sm-8" required placeholder="Enter Full Name" name="name"/>
                	</div>
                	
                	<div class="mt-3 d-flex align-items-center justify-content-center w-100">
                	    <label class=" col-5 col-lg-5 col-xxl-4 mate5">Email : </label>
                	    <input type="text" class="ms-3 col-6  col-sm-8" required placeholder="Enter Email" name="mail"/>
                	</div>
                	
                	<div class="mt-3 d-flex align-items-center justify-content-center w-100">
                	    <label class=" col-5 col-lg-5 col-xxl-4 mate5">Password : </label>
                	    <input type="password" class="ms-3 col-6 col-sm-8" required placeholder="Enter Password" name="pass"/>
                	</div>
                	<div class="mt- mt-4 d-flex align-items-center justify-content-center w-100">
                	    <button class="border-0 rounded-3 px-4 py-2 btn btn-primary" type="submit">Submit</button>
                	</div>
            	</div>
            </form>
        </div>
