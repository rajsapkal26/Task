                    ...
                    <div class="">
                        ...
                        <div class="offcanvas offcanvas-top h-75 " tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                            <div class="offcanvas-header container">
                            	<h5 class="offcanvas-title text-uppercase display-5 logo" id="offcanvasTopLabel">
                              		<svg class="col-8" version="1.1" x="0px" y="0px" width="175.748px" height="42.52px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52">
                                		<path fill-rule="evenodd" clip-rule="evenodd" fill="#333E48" d="M30.514,0.71c-0.034,0.003-0.066,0.008-0.056,0.056
                            C30.263,0.995,29.876,1.181,29.79,1.5c-0.148,0.548,0,1.568,0,2.427v36.459c0.265,0.221,0.506,0.465,0.725,0.734h6.187
                            c0.2-0.25,0.423-0.477,0.669-0.678V1.387C37.124,1.185,36.9,0.959,36.701,0.71H30.514z M117.517,12.731
                        	...
                        	<div class="offcanvas-body login container">        
                                <div class="d-md-flex justify-content-between">
                                    <div class="col-md-5">
                                        <h1 class="mb-3 product">LOGIN</h1>
                                        <form class="my-2" method="post" action="login.jsp">
                                            <div class="my-2 d-md-flex justify-content-evenly col-sm-6 col-md-12"> 
                                                ...
                                                <input type="email" class="col-12 col-md-6" name="input1" id="mail"/>
                                            </div>
                                            <div class="my-2 d-md-flex justify-content-evenly col-sm-6 col-md-12">
                                                <p class="m-0 col-md-6"><label for="pass">Password</label></p>
                                                <input type="password" class="col-12 col-md-6" name="input2" id="pass"/>
                                            </div>
                                            <p class="my-3"><a href="#" class="icon text-decoration-none ">Have you forgotten your password?</a></p>
          
                                            <button type="submit" class="my-2 but-2 btn btn-primary">LOG IN</button>
                                        </form>
                                    </div>
                                    <div class="col-md-5">
                                        <h1 class="mt-5 mt-md-0 text-uppercase product">Are you a new customer?</h1>
                                        ...
                                        <div>
                                            <a href="register.jsp" class="d-flex text-decoration-none justify-content-center align-items-center but border border-1 col-5 col-xl-3 py-1">Register Now</a>
                                        </div>
                                    </div>
                                </div>
                          	</div>
					...
					<figure class="col-sm-6 col-md-4 col-xl-3 p-3 mt-sm-3 border border-1">
						...
						<figcaption>
							...
							<div class="d-flex justify-content-between align-items-center">
                        		...
                        		<button class="border border-1 rounded-5 btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" role="button"><i class="bi bi-cart-plus fs-5"></i></button>
                    		</div>
						</figcaption>
					</figure>
			<%
